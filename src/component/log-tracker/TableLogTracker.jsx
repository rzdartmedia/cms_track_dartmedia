...
import SearchLogTracker from "./SearchLogTracker"

const TableLogTracker = (props) => {
  return (
    <div className='m-4'>
            ...
            <tbody className='bg-white divide-y dark:divide-gray-700 dark:bg-gray-800'>
              {props.dataLogTracks?.map((data) => (
                <tr
                  ...
                  <td className='px-2 py-3 text-sm'>{data.emailUser}</td>
                  <td className='px-2 py-3 text-sm capitalize'>
                    {data.nameAction}
                  </td>
                  <td className='px-2 py-3 text-sm capitalize'>
...
export default TableLogTracker
